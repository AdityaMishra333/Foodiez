...
router.post('/seed', async (req, res) => {
  const menuData = [
    { id:1, name:"Margherita Pizza", desc:"Classic tomato, mozzarella & fresh basil", price:249, category:"italian", emoji:"🍕", type:"veg" },
    { id:2, name:"Pepperoni Pizza", desc:"Loaded with spicy pepperoni & cheese", price:329, category:"italian", emoji:"🍕", type:"nonveg" },
    { id:3, name:"BBQ Chicken Pizza", desc:"Smoky BBQ sauce, grilled chicken, onions", price:359, category:"italian", emoji:"🍕", type:"nonveg" },
    { id:4, name:"Classic Burger", desc:"Beef patty, lettuce, cheese, pickles", price:179, category:"italian", emoji:"🍔", type:"nonveg" },
    { id:5, name:"Veggie Burger", desc:"Crispy aloo tikki, veggies & special sauce", price:149, category:"italian", emoji:"🍔", type:"veg" },
    { id:6, name:"Zinger Burger", desc:"Crispy fried chicken with coleslaw", price:199, category:"italian", emoji:"🍔", type:"nonveg" },
    { id:7, name:"Chicken Biryani", desc:"Slow-cooked basmati with aromatic spices", price:259, category:"Indian", emoji:"🍛", type:"nonveg" },
    { id:8, name:"Veg Biryani", desc:"Garden fresh veggies in saffron rice", price:199, category:"Indian", emoji:"🍛", type:"veg" },
    { id:9, name:"Mutton Biryani", desc:"Tender mutton pieces in rich biryani", price:329, category:"Indian", emoji:"🍛", type:"nonveg" },
